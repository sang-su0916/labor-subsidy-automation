...
export const PROGRAM_DOCUMENT_CHECKLISTS: Record<SubsidyProgram, DocumentChecklistItem[]> = {
  ...
  [SubsidyProgram.EMPLOYMENT_RETENTION]: [
    { id: 'er-1', documentName: '지원금 신청서', isRequired: true },
    { id: 'er-2', documentName: '고용유지계획서', isRequired: true },
    { id: 'er-3', documentName: '경영악화 증빙서류 (매출감소 등)', isRequired: true },
    { id: 'er-4', documentName: '휴업/휴직 실시 확인서', isRequired: true },
    { id: 'er-5', documentName: '근로자대표 동의서', isRequired: true },
    { id: 'er-6', documentName: '근로계약서 사본', isRequired: true },
    { id: 'er-7', documentName: '4대보험 가입자명부', isRequired: true },
    { id: 'er-8', documentName: '월별 임금대장', isRequired: true },
    { id: 'er-9', documentName: '휴업수당 지급 확인서', isRequired: true },
    { id: 'er-10', documentName: '사업자등록증 사본', isRequired: true },
    { id: 'er-11', documentName: '부가가치세 과세표준증명 (매출감소 증빙)', isRequired: true },
    { id: 'er-12', documentName: '대표자 신분증 사본', isRequired: true },
  ],
