                    ...
                    try {
                      const mcReportData: McReportData = {
                        ...
                        eligibleCalculations: report.eligibleCalculations.map(calc => ({
                          ...
                          eligibleEmployeeCount: calc.eligibleEmployeeCount,
                          perPersonMonthlyAmount: calc.perPersonMonthlyAmount,
                          perPersonQuarterlyAmount: calc.perPersonQuarterlyAmount,
                          notes: calc.notes,
                        })),
                    ...
                    try {
                      ...
                      const laborData: LaborAttorneyReportData = {
                        ...
                        businessInfo: {
                          name: report.businessInfo.name || '',
                          registrationNumber: report.businessInfo.registrationNumber || '',
                          representativeName: report.businessInfo.representativeName || '',
                          address: report.businessInfo.businessAddress || '',
                          employmentInsuranceNumber: report.businessInfo.employmentInsuranceNumber || '',
                          industryCode: report.businessInfo.industryCode || '',
                          industryName: report.businessInfo.industryName || '',
                          establishmentDate: report.businessInfo.establishmentDate || '',
                          totalEmployeeCount: report.businessInfo.headCount,
                          region: report.businessInfo.regionType === '비수도권' ? 'NON_CAPITAL' : 'CAPITAL',
                          isSmallBusiness: !!report.businessInfo.companySize,
                        },
