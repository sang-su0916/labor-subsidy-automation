...
const subsidyPrograms = [
  ...
  },
  {
    id: 'conversion',
    title: '정규직전환지원금',
    description: '기간제·파견·사내하도급 근로자를 정규직으로 전환한 30인 미만 사업장에 인건비를 지원합니다.',
    amount: '월 40만원 × 12개월 (임금 20만원+ 인상 시 월 60만원)',
    requirements: ['30인 미만 사업장', '6개월 이상 고용 후 정규직 전환', '전환 후 6개월 이상 고용유지'],
...
const requiredDocuments = [
  ...
  },
  {
    ...
    documents: [
      { name: '사업자등록증 사본', required: true },
      { name: '정규직 전환 전·후 근로계약서', required: true },
      { name: '취업규칙 또는 인사규정', required: true },
      { name: '월별 임금대장 (전환 전후 비교용)', required: true },
      { name: '4대보험 가입내역 확인서', required: true },
      { name: '정규직 전환 계획서', required: true },
